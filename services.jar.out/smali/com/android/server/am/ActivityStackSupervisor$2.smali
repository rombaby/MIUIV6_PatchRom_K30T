...
.method constructor <init>(Lcom/android/server/am/ActivityStackSupervisor;Landroid/app/IApplicationThread;Landroid/os/IBinder;ILjava/util/ArrayList;)V
    ...
    iput-object p2, p0, Lcom/android/server/am/ActivityStackSupervisor$2;->val$thumbnailThread:Landroid/app/IApplicationThread;

    iput-object p3, p0, Lcom/android/server/am/ActivityStackSupervisor$2;->val$token:Landroid/os/IBinder;

    iput p4, p0, Lcom/android/server/am/ActivityStackSupervisor$2;->val$NT:I

    iput-object p5, p0, Lcom/android/server/am/ActivityStackSupervisor$2;->val$thumbnails:Ljava/util/ArrayList;
...
.method public run()V
    ...
    .line 1945
    iget-object v0, p0, Lcom/android/server/am/ActivityStackSupervisor$2;->val$thumbnailThread:Landroid/app/IApplicationThread;
    ...
    iget-object v2, p0, Lcom/android/server/am/ActivityStackSupervisor$2;->val$token:Landroid/os/IBinder;
    ...
    .local v13, "i":I
    :goto_1
    iget v0, p0, Lcom/android/server/am/ActivityStackSupervisor$2;->val$NT:I

    if-ge v13, v0, :cond_1

    .line 1956
    iget-object v0, p0, Lcom/android/server/am/ActivityStackSupervisor$2;->val$thumbnails:Ljava/util/ArrayList;

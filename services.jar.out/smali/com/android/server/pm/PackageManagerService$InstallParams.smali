...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/pm/PackageManagerService$InstallParams$MountPoint;
    }
.end annotation
...
.method private getDefaultInstallLocation(I)I
    .locals 5
    .param p1, "recommendlocation"    # I

    .prologue
    .line 7516
    invoke-direct {p0}, Lcom/android/server/pm/PackageManagerService$InstallParams;->isSDcardExist()Z
    ...
    .line 7527
    .local v2, "location_new":I
    packed-switch v2, :pswitch_data_0

    .line 7542
    .end local v1    # "location":I
    .end local v2    # "location_new":I
    .end local p1    # "recommendlocation":I
    :cond_0
    :goto_0
    :pswitch_0
    return p1
    ...
    .restart local v2    # "location_new":I
    .restart local p1    # "recommendlocation":I
    :pswitch_1
    const/4 p1, 0x1
...
.method private installLocationPolicy(Landroid/content/pm/PackageInfoLite;I)I
    ...
    invoke-direct {p0, v4}, Lcom/android/server/pm/PackageManagerService$InstallParams;->getDefaultInstallLocation(I)I
...
.method private isSDcardExist()Z
    ...
    .line 7497
    .local v6, "storageVolumeList":[Landroid/os/storage/StorageVolume;
    if-eqz v6, :cond_1
    ...
    new-instance v4, Lcom/android/server/pm/PackageManagerService$InstallParams$MountPoint;

    const/4 v8, 0x0

    invoke-direct {v4, p0, v8}, Lcom/android/server/pm/PackageManagerService$InstallParams$MountPoint;-><init>(Lcom/android/server/pm/PackageManagerService$InstallParams;Lcom/android/server/pm/PackageManagerService$1;)V

    .line 7500
    .local v4, "mountPoint":Lcom/android/server/pm/PackageManagerService$InstallParams$MountPoint;
    invoke-virtual {v7}, Landroid/os/storage/StorageVolume;->getPath()Ljava/lang/String;

    move-result-object v8

    iput-object v8, v4, Lcom/android/server/pm/PackageManagerService$InstallParams$MountPoint;->mPath:Ljava/lang/String;

    .line 7501
    iget-object v8, v4, Lcom/android/server/pm/PackageManagerService$InstallParams$MountPoint;->mPath:Ljava/lang/String;

    invoke-virtual {v3, v8}, Landroid/os/storage/StorageManager;->getVolumeState(Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-boolean v8, v4, Lcom/android/server/pm/PackageManagerService$InstallParams$MountPoint;->mIsMounted:Z
    ...
    iput-boolean v8, v4, Lcom/android/server/pm/PackageManagerService$InstallParams$MountPoint;->mIsExternal:Z

    .line 7504
    iget-boolean v8, v4, Lcom/android/server/pm/PackageManagerService$InstallParams$MountPoint;->mIsExternal:Z

    if-eqz v8, :cond_0

    .line 7505
    iget-boolean v8, v4, Lcom/android/server/pm/PackageManagerService$InstallParams$MountPoint;->mIsMounted:Z
    ...
    .end local v1    # "i$":I
    .end local v2    # "len$":I
    .end local v4    # "mountPoint":Lcom/android/server/pm/PackageManagerService$InstallParams$MountPoint;
    ...
    .restart local v4    # "mountPoint":Lcom/android/server/pm/PackageManagerService$InstallParams$MountPoint;

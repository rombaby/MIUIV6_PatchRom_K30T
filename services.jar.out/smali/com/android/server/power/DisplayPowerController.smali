...
.field private static final LUX_ARRAY_SIZE:I = 0xf
...
.field private mRecentLuxArray:[F
...
.method public constructor <init>(Landroid/os/Looper;Landroid/content/Context;Lcom/android/server/power/Notifier;Lcom/android/server/LightsService;Lcom/android/server/TwilightService;Landroid/hardware/SensorManager;Lcom/android/server/display/DisplayManagerService;Lcom/android/server/power/SuspendBlocker;Lcom/android/server/power/DisplayBlanker;Lcom/android/server/power/DisplayPowerController$Callbacks;Landroid/os/Handler;)V
    ...
    iput-object v5, p0, Lcom/android/server/power/DisplayPowerController;->mRecentLuxArray:[F
...
.method private applyLightSensorMeasurement(JF)V
    ...
    .line 951
    iget-object v3, p0, Lcom/android/server/power/DisplayPowerController;->mRecentLuxArray:[F
    ...
    iget v4, p0, Lcom/android/server/power/DisplayPowerController;->curret_index:I

    aput p3, v3, v4

    .line 955
    iget v3, p0, Lcom/android/server/power/DisplayPowerController;->curret_index:I

    add-int/lit8 v3, v3, 0x1

    rem-int/lit8 v3, v3, 0xf

    iput v3, p0, Lcom/android/server/power/DisplayPowerController;->curret_index:I
    ...
    iget-object v4, p0, Lcom/android/server/power/DisplayPowerController;->mRecentLuxArray:[F
    ...
    const-string v5, "mRecentLuxArray: , i = "
    ...
    const-string v5, ", mRecentLuxArray ="

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-object v5, p0, Lcom/android/server/power/DisplayPowerController;->mRecentLuxArray:[F
    ...
    iput v3, p0, Lcom/android/server/power/DisplayPowerController;->mRecentLongTermAverageLux:F
    ...
    const-string v5, "applyLightSensorMeasurement: , time="
    ...
    const-string v5, ", mRecentShortTermAverageLux="

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget v5, p0, Lcom/android/server/power/DisplayPowerController;->mRecentShortTermAverageLux:F

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(F)Ljava/lang/StringBuilder;

    move-result-object v4

    const-string v5, ",mRecentLongTermAverageLux="

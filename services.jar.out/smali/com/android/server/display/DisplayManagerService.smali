...
.method private configureDisplayInTransactionLocked(Lcom/android/server/display/DisplayDevice;)V
    ...
    .line 1059
    .local v1, "displayExistsAndEmpty":Z
    ...
    const-string v7, "Missing logical display to use for physical display device: "
    ...
    .end local v0    # "display":Lcom/android/server/display/LogicalDisplay;
    .end local v1    # "displayExistsAndEmpty":Z
    ...
    .line 1079
    .restart local v0    # "display":Lcom/android/server/display/LogicalDisplay;
    .restart local v1    # "displayExistsAndEmpty":Z
    .restart local v4    # "isPrivate":Z
    :cond_4
    iget v7, p0, Lcom/android/server/display/DisplayManagerService;->mAllDisplayBlankStateFromPowerManager:I
    ...
    .line 1084
    iget-object v6, p0, Lcom/android/server/display/DisplayManagerService;->mDefaultViewport:Lcom/android/server/display/DisplayViewport;

    iget-boolean v6, v6, Lcom/android/server/display/DisplayViewport;->valid:Z
    ...
    invoke-static {v6, v0, p1}, Lcom/android/server/display/DisplayManagerService;->setViewportLocked(Lcom/android/server/display/DisplayViewport;Lcom/android/server/display/LogicalDisplay;Lcom/android/server/display/DisplayDevice;)V

    .line 1088
    :cond_5
    iget-object v6, p0, Lcom/android/server/display/DisplayManagerService;->mExternalTouchViewport:Lcom/android/server/display/DisplayViewport;

    iget-boolean v6, v6, Lcom/android/server/display/DisplayViewport;->valid:Z

    if-nez v6, :cond_2

    iget v6, v2, Lcom/android/server/display/DisplayDeviceInfo;->touch:I
    ...
    iput-boolean v5, v6, Lcom/android/server/display/DisplayViewport;->valid:Z

    .line 1099
    iget-object v5, p0, Lcom/android/server/display/DisplayManagerService;->mExternalTouchViewport:Lcom/android/server/display/DisplayViewport;

    const/4 v6, -0x1

    iput v6, v5, Lcom/android/server/display/DisplayViewport;->displayId:I

    goto :goto_1

    .end local v3    # "isBlanked":Z
    :cond_6
    move v3, v6
    ...
    .line 1102
    .restart local v3    # "isBlanked":Z
    :cond_7
    iget-object v5, p0, Lcom/android/server/display/DisplayManagerService;->mExternalTouchViewport:Lcom/android/server/display/DisplayViewport;

    invoke-static {v5, v0, p1}, Lcom/android/server/display/DisplayManagerService;->setViewportLocked(Lcom/android/server/display/DisplayViewport;Lcom/android/server/display/LogicalDisplay;Lcom/android/server/display/DisplayDevice;)V

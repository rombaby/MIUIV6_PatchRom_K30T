...
.method public onChange(Z)V
    ...
    invoke-static {v0}, Landroid/media/AudioService;->access$6300(Landroid/media/AudioService;)Ljava/lang/Object;
    ...
    invoke-static {v0, v2, v3}, Landroid/media/AudioService;->access$5500(Landroid/media/AudioService;IZ)V
    ...
    # getter for: Landroid/media/AudioService;->mContentResolver:Landroid/content/ContentResolver;
    invoke-static {v2}, Landroid/media/AudioService;->access$3500(Landroid/media/AudioService;)Landroid/content/ContentResolver;

    move-result-object v2

    # invokes: Landroid/media/AudioService;->readDockAudioSettings(Landroid/content/ContentResolver;)V
    invoke-static {v0, v2}, Landroid/media/AudioService;->access$7900(Landroid/media/AudioService;Landroid/content/ContentResolver;)V

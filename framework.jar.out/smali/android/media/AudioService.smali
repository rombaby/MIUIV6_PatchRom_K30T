...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/media/AudioService$FmModeStackEntry;,
        Landroid/media/AudioService$FmModeDeathHandler;,
...
.field private static final BEFORE_EARPHONE_PLUGIN_ACTIVE_PROFILE:Ljava/lang/String; = "before_earphone_plugin_active_profile"

.field private static final BEFORE_EARPHONE_PLUGIN_MUSIC_VOLUME:Ljava/lang/String; = "before_earphone_plugin_music_volume"

.field private static final BEFORE_EARPHONE_PLUGIN_NOTIFICATION_VOLUME:Ljava/lang/String; = "before_earphone_plugin_notification_volume"

.field private static final BEFORE_EARPHONE_PLUGIN_RING_VOLUME:Ljava/lang/String; = "before_earphone_plugin_ring_volume"

.field private static final BEFORE_EARPHONE_PLUGIN_SYSTEM_VOLUME:Ljava/lang/String; = "before_earphone_plugin_system_volume"
...
.field private static final EARPHONE_PLUGIN_MUSIC_VOLUME:Ljava/lang/String; = "earphone_plugin_music_volume"

.field private static final EARPHONE_PLUGIN_NOTIFICATION_VOLUME:Ljava/lang/String; = "earphone_plugin_notification_volume"

.field private static final EARPHONE_PLUGIN_RING_VOLUME:Ljava/lang/String; = "earphone_plugin_ring_volume"

.field private static final EARPHONE_PLUGIN_SYSTEM_VOLUME:Ljava/lang/String; = "earphone_plugin_system_volume"

.field private static final GROUP_TOUCH_SOUNDS:Ljava/lang/String; = "touch_sounds"

.field private static final KEY_ACTIVE_PROFILE:Ljava/lang/String; = "mtk_audioprofile_active"
...
.field private static final MSG_SHOW_LENOVO_TOAST:I = 0x1a

.field private static final MSG_UNLOAD_SOUND_EFFECTS:I = 0x14

.field private static final MSG_UPDATE_LENOVO_RINGER_MODE:I = 0x1c

.field private static final MSG_UPDATE_LENOVO_VOLUME:I = 0x1b
...
.field private static final mFmModeLock:Ljava/lang/Object;
...
.field private final mFmModeStack:Ljava/util/Stack;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Stack",
            "<",
...
.field private mFmRxMode:I

.field private mFmStreamOn:Z
...
.field private mMusicAndFmDefaultVolume:I

.field private mMusicAndFmLimitedVolume:I

.field private mMuteAffectedStreams:I

.field private mNotificationDefaultVolume:I
...
.field private mRingDefaultVolume:I
...
.field private mSystemDefaultVolume:I
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/media/AudioService;->mFmModeLock:Ljava/lang/Object;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 192
    iput-boolean v6, p0, Landroid/media/AudioService;->mHeadsetOrHeadphoneOn:Z
    ...
    .line 489
    iput v5, p0, Landroid/media/AudioService;->mMusicAndFmLimitedVolume:I

    .line 490
    const/16 v0, 0x8

    iput v0, p0, Landroid/media/AudioService;->mMusicAndFmDefaultVolume:I

    .line 491
    iput v3, p0, Landroid/media/AudioService;->mRingDefaultVolume:I

    .line 492
    iput v3, p0, Landroid/media/AudioService;->mSystemDefaultVolume:I

    .line 493
    iput v3, p0, Landroid/media/AudioService;->mNotificationDefaultVolume:I
    ...
    .line 5432
    iput-boolean v6, p0, Landroid/media/AudioService;->mFmStreamOn:Z

    .line 5436
    iput v6, p0, Landroid/media/AudioService;->mForcedUseForFM:I
    ...
    iput-object v0, p0, Landroid/media/AudioService;->mFmModeStack:Ljava/util/Stack;
    ...
    invoke-direct {v0, v1, v4, v5, p0}, Landroid/media/MediaFocusControl;-><init>(Landroid/os/Looper;Landroid/content/Context;Landroid/media/VolumeController;Landroid/media/AudioService;)V
    ...
    .line 634
    invoke-direct {p0}, Landroid/media/AudioService;->initFmMode()V
...
.method static synthetic access$6600(Landroid/media/AudioService;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Landroid/media/AudioService;
...
.method static synthetic access$6700(Landroid/media/AudioService;)I
    ...
    .prologue
    .line 121
    iget v0, p0, Landroid/media/AudioService;->mSystemDefaultVolume:I
...
.method static synthetic access$6800(Landroid/media/AudioService;)I
    ...
    .prologue
    .line 121
    iget v0, p0, Landroid/media/AudioService;->mRingDefaultVolume:I
...
.method static synthetic access$6900(Landroid/media/AudioService;)I
    ...
    .prologue
    .line 121
    iget v0, p0, Landroid/media/AudioService;->mNotificationDefaultVolume:I
...
.method static synthetic access$7600(Landroid/media/AudioService;Z)V
    .locals 0
    .param p0, "x0"    # Landroid/media/AudioService;
    .param p1, "x1"    # Z
...
.method static synthetic access$9000()Ljava/lang/Object;
    ...
    .prologue
    .line 121
    sget-object v0, Landroid/media/AudioService;->mFmModeLock:Ljava/lang/Object;
...
.method static synthetic access$9100(Landroid/media/AudioService;)Ljava/util/Stack;
    ...
    .prologue
    .line 121
    iget-object v0, p0, Landroid/media/AudioService;->mFmModeStack:Ljava/util/Stack;
...
.method static synthetic access$9200(Landroid/media/AudioService;Z)V
    ...
    .prologue
    .line 121
    invoke-direct {p0, p1}, Landroid/media/AudioService;->setFmRxMode(Z)V
...
.method private broadcastRingerMode(I)V
    ...
    invoke-virtual {v1, v2}, Landroid/media/AudioService$AudioHandler;->sendMessage(Landroid/os/Message;)Z
...
.method private checkReActiveSafeMediaVolume(III)Z
    .locals 3
...
.method private handleMediaRestartForFmMode()V
    .locals 2
    ...
    const-string v1, "handleMediaRestartForFmMode"

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 5591
    sget-object v1, Landroid/media/AudioService;->mFmModeLock:Ljava/lang/Object;
    ...
    invoke-direct {p0, v0}, Landroid/media/AudioService;->setFmRxMode(Z)V
...
.method private initFmMode()V
    ...
    invoke-direct {p0, v1}, Landroid/media/AudioService;->setFmRxMode(Z)V

    .line 5576
    sget-object v2, Landroid/media/AudioService;->mFmModeLock:Ljava/lang/Object;

    monitor-enter v2

    .line 5577
    :try_start_0
    iget-object v1, p0, Landroid/media/AudioService;->mFmModeStack:Ljava/util/Stack;
    ...
    const-string v3, "in setFmRxMode : pop"
...
.method private notifyRingerModeChanged()V
    ...
    .line 5356
    :try_start_1
    iget-object v3, v2, Landroid/media/AudioService$Record;->mCallback:Lcom/wingtech/audioprofile/IAudioProfileListener;

    iget v5, p0, Landroid/media/AudioService;->mRingerMode:I

    invoke-interface {v3, v5}, Lcom/wingtech/audioprofile/IAudioProfileListener;->onRingerModeChanged(I)V
    :try_end_1
...
.method private notifyVibrateSettingChanged(I)V
    ...
    invoke-interface {v3, p1, v5}, Lcom/wingtech/audioprofile/IAudioProfileListener;->onVibrateSettingChanged(II)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method private onConfigureSafeVolume(Z)V
    ...
    .line 2656
    .local v9, "safeMusicVolumeIndex":I
    iget-object v0, p0, Landroid/media/AudioService;->mSafeMediaVolumeIndexs:Ljava/util/HashMap;
    ...
    .end local v9    # "safeMusicVolumeIndex":I
    :cond_2
    monitor-exit v10
    ...
    .restart local v9    # "safeMusicVolumeIndex":I
    :cond_3
    const/4 v3, 0x5
...
.method private onSetWiredDeviceConnectionState(IILjava/lang/String;)V
    ...
    const-string/jumbo v7, "zzz onSetWiredDeviceConnectionState state="
    ...
    iput-boolean v5, v0, Landroid/media/AudioService;->mHeadsetOrHeadphoneOn:Z

    .line 4351
    move-object/from16 v0, p0

    iget-object v5, v0, Landroid/media/AudioService;->mContentResolver:Landroid/content/ContentResolver;
    ...
    .line 4352
    .local v12, "activeProfileKey":Ljava/lang/String;
    move-object/from16 v0, p0

    iget-object v5, v0, Landroid/media/AudioService;->mContentResolver:Landroid/content/ContentResolver;

    const-string v6, "before_earphone_plugin_active_profile"
    ...
    .line 4353
    .local v14, "beforeActiviProfileKey":Ljava/lang/String;
    move-object/from16 v0, p0

    iget-object v5, v0, Landroid/media/AudioService;->mContentResolver:Landroid/content/ContentResolver;

    const-string v6, "before_earphone_plugin_music_volume"
    ...
    .line 4354
    .local v15, "beforeMusicVolume":I
    move-object/from16 v0, p0

    iget-object v5, v0, Landroid/media/AudioService;->mContentResolver:Landroid/content/ContentResolver;

    const-string v6, "before_earphone_plugin_system_volume"
    ...
    .line 4355
    .local v18, "beforeSystemVolume":I
    move-object/from16 v0, p0

    iget-object v5, v0, Landroid/media/AudioService;->mContentResolver:Landroid/content/ContentResolver;

    const-string v6, "before_earphone_plugin_ring_volume"
    ...
    .line 4356
    .local v17, "beforeRingVolume":I
    move-object/from16 v0, p0

    iget-object v5, v0, Landroid/media/AudioService;->mContentResolver:Landroid/content/ContentResolver;

    const-string v6, "before_earphone_plugin_notification_volume"
    ...
    .line 4357
    .local v16, "beforeNotificationVolume":I
    const-string v5, "AudioService"
    ...
    const-string/jumbo v7, "zzz plug out beforeMusicVolume="
    ...
    const-string v7, ",beforeSystemVolume ="
    ...
    const-string v7, ",beforeRingVolume= "
    ...
    const-string v7, ",beforeNotificationVolume= "
    ...
    const-string v7, ",activeProfileKey="
    ...
    const-string v7, ",beforeActiviProfileKey="
    ...
    invoke-virtual {v13, v5, v15, v6}, Landroid/media/AudioManager;->setStreamVolume(III)V
    ...
    invoke-virtual {v13, v5, v0, v6}, Landroid/media/AudioManager;->setStreamVolume(III)V
    ...
    const-string/jumbo v6, "onSetWiredDeviceConnectionState() no need to setForceUse"
    ...
    .line 4397
    .end local v12    # "activeProfileKey":Ljava/lang/String;
    .end local v13    # "audioManager":Landroid/media/AudioManager;
    .end local v14    # "beforeActiviProfileKey":Ljava/lang/String;
    .end local v15    # "beforeMusicVolume":I
    .end local v16    # "beforeNotificationVolume":I
    .end local v17    # "beforeRingVolume":I
    .end local v18    # "beforeSystemVolume":I
    .end local v23    # "isHeadphoneOff":Z
    .end local v24    # "isHeadsetOn":Z
    :cond_5
    move/from16 v0, p1
    ...
    invoke-direct {v0, v6, v1, v5}, Landroid/media/AudioService;->handleDeviceConnection(ZILjava/lang/String;)Z
    ...
    invoke-virtual {v0, v5}, Landroid/media/AudioService;->setBluetoothA2dpOnInt(Z)V
    ...
    .line 4407
    .restart local v12    # "activeProfileKey":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    invoke-static {v5, v6, v12}, Landroid/provider/Settings$System;->putString(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v6, "earphone_plugin_music_volume"
    ...
    .line 4409
    .local v22, "currentMusicVolume":I
    const/4 v5, 0x1

    move-object/from16 v0, p0

    invoke-virtual {v0, v5}, Landroid/media/AudioService;->getStreamVolume(I)I

    move-result v21

    .line 4410
    .local v21, "curSystemVolume":I
    const/4 v5, 0x2
    ...
    .line 4412
    .local v19, "curNotificationVolume":I
    const-string v5, "AudioService"
    ...
    const-string/jumbo v7, "zzz plug in currentMusicVolume="
    ...
    const-string v7, ",curSystemVolume ="
    ...
    const-string v7, ",curNotificationVolume= "
    ...
    iget v5, v0, Landroid/media/AudioService;->mMusicAndFmLimitedVolume:I
    ...
    iget v6, v0, Landroid/media/AudioService;->mMusicAndFmDefaultVolume:I

    const/4 v7, 0x0

    invoke-virtual {v13, v5, v6, v7}, Landroid/media/AudioManager;->setStreamVolume(III)V

    .line 4425
    :goto_4
    move-object/from16 v0, p0

    iget v5, v0, Landroid/media/AudioService;->mSystemDefaultVolume:I
    ...
    iget v6, v0, Landroid/media/AudioService;->mSystemDefaultVolume:I
    ...
    iget v5, v0, Landroid/media/AudioService;->mRingDefaultVolume:I
    ...
    iget v6, v0, Landroid/media/AudioService;->mRingDefaultVolume:I
    ...
    iget v5, v0, Landroid/media/AudioService;->mNotificationDefaultVolume:I
    ...
    iget v6, v0, Landroid/media/AudioService;->mNotificationDefaultVolume:I
    ...
    .end local v12    # "activeProfileKey":Ljava/lang/String;
    .end local v13    # "audioManager":Landroid/media/AudioManager;
    .end local v19    # "curNotificationVolume":I
    .end local v20    # "curRingVolume":I
    .end local v21    # "curSystemVolume":I
    .end local v22    # "currentMusicVolume":I
    :cond_9
    :goto_7
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Landroid/media/AudioService;->sendDeviceConnectionIntent(IILjava/lang/String;Z)V
    ...
    .line 4382
    .end local v25    # "isUsb":Z
    .restart local v12    # "activeProfileKey":Ljava/lang/String;
    .restart local v13    # "audioManager":Landroid/media/AudioManager;
    .restart local v14    # "beforeActiviProfileKey":Ljava/lang/String;
    .restart local v15    # "beforeMusicVolume":I
    .restart local v16    # "beforeNotificationVolume":I
    .restart local v17    # "beforeRingVolume":I
    .restart local v18    # "beforeSystemVolume":I
    :cond_c
    const/16 v23, 0x0
    ...
    .restart local v12    # "activeProfileKey":Ljava/lang/String;
    .restart local v13    # "audioManager":Landroid/media/AudioManager;
    .restart local v19    # "curNotificationVolume":I
    .restart local v20    # "curRingVolume":I
    .restart local v21    # "curSystemVolume":I
    .restart local v22    # "currentMusicVolume":I
    :cond_10
    const/4 v5, 0x3
...
.method private setFmRxMode(Z)V
    .locals 6
    .param p1, "on"    # Z
    ...
    const-string v2, "in setFmRxMode bool pid "
    ...
    const-string v2, "in setFmRxMode : "
    ...
    iget v0, p0, Landroid/media/AudioService;->mFmRxMode:I
    ...
    const-string v1, "FmModeOn on and on"
    ...
    const-string/jumbo v1, "out setFmRxMode bool"
    ...
    const-string v1, "FmModeOn off and off"
    ...
    .line 5607
    iput-boolean v3, p0, Landroid/media/AudioService;->mFmStreamOn:Z

    .line 5608
    iput v3, p0, Landroid/media/AudioService;->mFmRxMode:I

    .line 5609
    const-string v0, ""

    invoke-static {v4, v3, v0}, Landroid/media/AudioSystem;->setDeviceConnectionState(IILjava/lang/String;)I
    ...
    .line 5616
    :cond_2
    iput-boolean v5, p0, Landroid/media/AudioService;->mFmStreamOn:Z

    .line 5617
    iput v5, p0, Landroid/media/AudioService;->mFmRxMode:I

    .line 5618
    const-string v0, ""

    invoke-static {v4, v5, v0}, Landroid/media/AudioSystem;->setDeviceConnectionState(IILjava/lang/String;)I
...
.method private setReSafeMediaVolumeEnabled(Z)V
    .locals 9
    .param p1, "on"    # Z
    ...
    .line 5096
    .local v7, "safeMusicVolumeState":I
    if-eqz v7, :cond_0
    ...
    .line 5110
    .end local v7    # "safeMusicVolumeState":I
    :cond_0
    :goto_0
    monitor-exit v8
    ...
    .line 5101
    .restart local v7    # "safeMusicVolumeState":I
    :cond_1
    if-nez p1, :cond_0
...
.method public adjustStreamVolume(IIILjava/lang/String;)V
    ...
    iget v4, v0, Landroid/media/AudioService;->mMusicAndFmLimitedVolume:I

    if-gt v3, v4, :cond_d

    move-object/from16 v0, p0

    iget v3, v0, Landroid/media/AudioService;->mMusicAndFmLimitedVolume:I

    if-le v13, v3, :cond_d

    .line 988
    invoke-virtual/range {p0 .. p0}, Landroid/media/AudioService;->disableSafeMediaVolume()V
    ...
    invoke-virtual {v4, v5, v7, v9, v0}, Landroid/media/AudioService$AudioHandler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-direct {v0, v1, v3, v6}, Landroid/media/AudioService;->checkReActiveSafeMediaVolume(III)Z
    ...
    const-string/jumbo v5, "zzz adjustStreamVolume() checkReActiveSafeMediaVolume cvtindex= "
    ...
    iput v0, v1, Landroid/media/AudioService;->mCheckSafeMediaType:I
    ...
    invoke-direct {v0, v3}, Landroid/media/AudioService;->setReSafeMediaVolumeEnabled(Z)V

    .line 1033
    .end local v12    # "cvtindex":I
    :cond_a
    move-object/from16 v0, p0
    ...
    div-int/lit8 v7, v13, 0xa

    const/4 v9, 0x0

    move/from16 v0, p1

    invoke-virtual {v4, v5, v0, v7, v9}, Landroid/media/AudioService$AudioHandler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    const-string/jumbo v5, "zzz adjustStreamVolume() mHeadsetOrHeadphoneOn="
    ...
    iget-boolean v5, v0, Landroid/media/AudioService;->mHeadsetOrHeadphoneOn:Z

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v4

    const-string v5, ",safe volume oldIndex="
...
.method public isFmActive()Z
    ...
    .prologue
    .line 5659
    iget-boolean v0, p0, Landroid/media/AudioService;->mFmStreamOn:Z
...
.method public listenRingerModeAndVolume(Lcom/wingtech/audioprofile/IAudioProfileListener;I)V
    ...
    .line 5287
    :try_start_3
    iget-object v6, v4, Landroid/media/AudioService$Record;->mCallback:Lcom/wingtech/audioprofile/IAudioProfileListener;

    iget v8, p0, Landroid/media/AudioService;->mRingerMode:I

    invoke-interface {v6, v8}, Lcom/wingtech/audioprofile/IAudioProfileListener;->onRingerModeChanged(I)V
    :try_end_3
    ...
    .line 5280
    iput-object p1, v4, Landroid/media/AudioService$Record;->mCallback:Lcom/wingtech/audioprofile/IAudioProfileListener;
    ...
    invoke-interface {v6, v8, v9, v10}, Lcom/wingtech/audioprofile/IAudioProfileListener;->onRingerVolumeChanged(IILjava/lang/String;)V
    :try_end_8
    ...
    invoke-interface {v6, v8, v9}, Lcom/wingtech/audioprofile/IAudioProfileListener;->onVibrateSettingChanged(II)V
    :try_end_a
...
.method public setFmRxMode(ILandroid/os/IBinder;Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string v4, "in setFmRxMode : "
    ...
    .local v3, "on":Z
    :goto_0
    invoke-direct {p0, v3}, Landroid/media/AudioService;->setFmRxMode(Z)V

    .line 5537
    sget-object v12, Landroid/media/AudioService;->mFmModeLock:Ljava/lang/Object;
    ...
    .line 5546
    new-instance v5, Landroid/media/AudioService$FmModeDeathHandler;

    move-object/from16 v0, p2

    invoke-direct {v5, p0, v0}, Landroid/media/AudioService$FmModeDeathHandler;-><init>(Landroid/media/AudioService;Landroid/os/IBinder;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 5548
    .local v5, "afdh":Landroid/media/AudioService$FmModeDeathHandler;
    const/4 v1, 0x0
    ...
    :goto_1
    :try_start_2
    iget-object v13, p0, Landroid/media/AudioService;->mFmModeStack:Ljava/util/Stack;

    new-instance v1, Landroid/media/AudioService$FmModeStackEntry;
    ...
    invoke-direct/range {v1 .. v8}, Landroid/media/AudioService$FmModeStackEntry;-><init>(Landroid/media/AudioService;ZLandroid/os/IBinder;Landroid/media/AudioService$FmModeDeathHandler;Ljava/lang/String;Ljava/lang/String;I)V
    ...
    const-string v2, "in setFmRxMode : monitor this app"

    invoke-static {v1, v2}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 5568
    .end local v5    # "afdh":Landroid/media/AudioService$FmModeDeathHandler;
    :goto_2
    monitor-exit v12
    ...
    .restart local v5    # "afdh":Landroid/media/AudioService$FmModeDeathHandler;
    :catch_0
    move-exception v9
    ...
    const-string/jumbo v4, "setFmRxMode could not link to "
    ...
    const-string v2, "in setFmRxMode : pop"
    ...
    check-cast v10, Landroid/media/AudioService$FmModeStackEntry;

    .line 5562
    .local v10, "fse":Landroid/media/AudioService$FmModeStackEntry;
    invoke-virtual {v10}, Landroid/media/AudioService$FmModeStackEntry;->unlinkToDeath()V

    goto :goto_2

    .line 5563
    .end local v10    # "fse":Landroid/media/AudioService$FmModeStackEntry;
    :cond_2
    if-eqz v3, :cond_3
    ...
    const-string/jumbo v2, "repeated setFmRxMode on"
    ...
    const-string/jumbo v2, "repeated setFmRxMode off"
...
.method public setSpeakerfmOn(Z)V
    ...
    const-string v1, "in setSpeakerfmOn"
    ...
    const-string/jumbo v1, "out setSpeakerfmOn"
...
.method public setStreamVolume(IIILjava/lang/String;)V
    ...
    .line 1111
    :cond_2
    iget-object v1, p0, Landroid/media/AudioService;->mAppOps:Landroid/app/AppOpsManager;

    sget-object v2, Landroid/media/AudioService;->STEAM_VOLUME_OPS:[I
    ...
    .line 1120
    invoke-virtual {v9, v6}, Landroid/media/AudioService$VolumeStreamState;->getIndex(I)I
    ...
    invoke-direct {p0, v1, p1, v10}, Landroid/media/AudioService;->rescaleIndex(III)I
    ...
    .line 1128
    :try_start_1
    iget-object v1, p0, Landroid/media/AudioService;->mA2dp:Landroid/bluetooth/BluetoothA2dp;
    ...
    invoke-virtual {v1, p2}, Landroid/bluetooth/BluetoothA2dp;->setAvrcpAbsoluteVolume(I)V
    ...
    :cond_5
    :goto_1
    invoke-direct {p0, v10, p2, v6}, Landroid/media/AudioService;->checkSafeMediaVolume(III)Z
    ...
    .line 1158
    new-instance v1, Landroid/media/AudioService$StreamVolumeCommand;
    ...
    invoke-direct/range {v1 .. v6}, Landroid/media/AudioService$StreamVolumeCommand;-><init>(Landroid/media/AudioService;IIII)V
    ...
    .line 1161
    .local v7, "covtIndex":I
    iget-boolean v1, p0, Landroid/media/AudioService;->mHeadsetOrHeadphoneOn:Z

    if-eqz v1, :cond_8

    div-int/lit8 v1, v8, 0xa

    iget v2, p0, Landroid/media/AudioService;->mMusicAndFmLimitedVolume:I

    if-gt v1, v2, :cond_8

    iget v1, p0, Landroid/media/AudioService;->mMusicAndFmLimitedVolume:I

    if-le v7, v1, :cond_8

    .line 1162
    invoke-virtual {p0}, Landroid/media/AudioService;->disableSafeMediaVolume()V
    ...
    invoke-virtual {v2, v3, v4, v5, v12}, Landroid/media/AudioService$AudioHandler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-direct {p0, p1, v8, p2, v0}, Landroid/media/AudioService;->sendVolumeUpdate(IIII)V

    .line 1185
    invoke-direct {p0, v10, p2, v6}, Landroid/media/AudioService;->checkReActiveSafeMediaVolume(III)Z
    ...
    const-string/jumbo v3, "zzz:setStreamVolume() checkReActiveSafeMediaVolume covtIndex= "
    ...
    .line 1189
    iput v10, p0, Landroid/media/AudioService;->mCheckSafeMediaType:I

    .line 1190
    const/4 v1, 0x1

    invoke-direct {p0, v1}, Landroid/media/AudioService;->setReSafeMediaVolumeEnabled(Z)V
    ...
    invoke-virtual {v2, v3, p1, v4, v5}, Landroid/media/AudioService$AudioHandler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    const-string/jumbo v3, "zzz setStreamVolume() mHeadsetOrHeadphoneOn="

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-boolean v3, p0, Landroid/media/AudioService;->mHeadsetOrHeadphoneOn:Z

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v2

    const-string v3, ",safe volume oldIndex="
    ...
    invoke-direct {p0, v1, v2, v3, v4}, Landroid/media/AudioService;->onSetStreamVolume(IIII)V
    ...
    invoke-direct {p0, p1, p2, v0, v6}, Landroid/media/AudioService;->onSetStreamVolume(IIII)V
    ...
    invoke-virtual {v1, v6}, Landroid/media/AudioService$VolumeStreamState;->getIndex(I)I
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_1

...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/internal/telephony/IccSmsInterfaceManager$InternalHandler;
    }
.end annotation
...
.field private mHandler:Lcom/android/internal/telephony/IccSmsInterfaceManager$InternalHandler;
...
.method protected constructor <init>(Lcom/android/internal/telephony/PhoneBase;)V
    ...
    const-string v1, "IccSmsInterfaceManager_Thread"
    ...
    .line 143
    new-instance v1, Lcom/android/internal/telephony/IccSmsInterfaceManager$InternalHandler;

    invoke-virtual {v0}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v2

    invoke-direct {v1, p0, v2}, Lcom/android/internal/telephony/IccSmsInterfaceManager$InternalHandler;-><init>(Lcom/android/internal/telephony/IccSmsInterfaceManager;Landroid/os/Looper;)V

    iput-object v1, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mHandler:Lcom/android/internal/telephony/IccSmsInterfaceManager$InternalHandler;
...
.method private isMmsUid(I)Z
    ...
    .line 300
    .local v1, "MMS_PKG":Ljava/lang/String;
    const/4 v3, -0x1
    ...
    .line 302
    .local v0, "IDEAFRIENDS_PKG":Ljava/lang/String;
    const/4 v2, -0x1

    .line 304
    .local v2, "ideafriendsUid":I
    :try_start_0
    ...
    const-string v6, "  ideafriendsUid =  "
...
.method private isUidAllowed(I)Z
    ...
    .line 210
    .local v3, "ideafriendsUid":I
    const-string v2, "com.android.phone"

    .line 211
    .local v2, "PHONE_PKG":Ljava/lang/String;
    const/4 v5, -0x1
    ...
    const-string v8, "isUidAllowed    uid = "
    ...
    const-string v8, "  ideafriendsUid =  "
...
.method private setCdmaBroadcastActivation(Z)Z
    ...
    .line 1026
    :try_start_0
    iget-object v2, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mHandler:Lcom/android/internal/telephony/IccSmsInterfaceManager$InternalHandler;
...
.method public getAllMessagesFromIccEf(Ljava/lang/String;)Ljava/util/List;
    ...
    const-string v5, "getAllMessagesFromIccEf    callingPackage = "
    ...
    const-string v4, "getAllMessagesFromIccEf    MODE_ALLOWED"
    ...
    .line 397
    :cond_2
    iget-object v3, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mHandler:Lcom/android/internal/telephony/IccSmsInterfaceManager$InternalHandler;
...
.method public updateMessageOnIccEf(Ljava/lang/String;II[B)Z
    ...
    const-string v7, "updateMessageOnIccEf    callingPackage = "
    ...
    invoke-direct {p0, v2}, Lcom/android/internal/telephony/IccSmsInterfaceManager;->isUidAllowed(I)Z
    ...
    const-string v4, "updateMessageOnIccEf    MODE_ALLOWED"
    ...
    .line 264
    iget-object v1, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mHandler:Lcom/android/internal/telephony/IccSmsInterfaceManager$InternalHandler;
